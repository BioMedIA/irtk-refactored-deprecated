...
#ifndef _IRTKFASTCUBICBSPLINEINTERPOLATEIMAGEFUNCTION_H
#define _IRTKFASTCUBICBSPLINEINTERPOLATEIMAGEFUNCTION_H
...
class irtkGenericFastCubicBSplineInterpolateImageFunction
...
public:
  ...
  /// Destructor
  virtual ~irtkGenericFastCubicBSplineInterpolateImageFunction();
  ...
  void Jacobian2D(irtkMatrix &, double, double, double = 0, double = 0) const;
  ...
  void Jacobian2D(irtkMatrix &, const TOtherImage *, double, double, double = 0, double = 0) const;

  /// Get 1st order derivatives of given 3D image at arbitrary location (in pixels)
  ///
  /// This function is used when no extrapolator was set.
  void Jacobian3D(irtkMatrix &, double, double, double = 0, double = 0) const;
  ...
  /// subclass of irtkExtrapolateImageFunction.
  template <class TOtherImage>
  void Jacobian3D(irtkMatrix &, const TOtherImage *, double, double, double = 0, double = 0) const;

  /// Get 1st order derivatives of given 4D image at arbitrary location (in pixels)
  ///
  /// This function is used when no extrapolator was set.
  void Jacobian4D(irtkMatrix &, double, double, double = 0, double = 0) const;
  ...
  /// subclass of irtkExtrapolateImageFunction.
  template <class TOtherImage>
  void Jacobian4D(irtkMatrix &, const TOtherImage *, double, double, double = 0, double = 0) const;

  /// Get 1st order derivatives of given image at arbitrary location (in pixels)
  void Jacobian(irtkMatrix &, double, double, double = 0, double = 0) const;
  ...
  /// subclass of irtkExtrapolateImageFunction.
  template <class TOtherImage>
  void Jacobian(irtkMatrix &, const TOtherImage *, double, double, double = 0, double = 0) const;

  /// Get 1st order derivatives of given image at arbitrary location (in pixels)
  void EvaluateJacobianInside(irtkMatrix &, double, double, double = 0, double = 0) const;

  /// Get 1st order derivatives of given image at arbitrary location (in pixels)
  void EvaluateJacobianOutside(irtkMatrix &, double, double, double = 0, double = 0) const;

  /// Get 1st order derivatives of given image at arbitrary location (in pixels)
  void EvaluateJacobian(irtkMatrix &, double, double, double = 0, double = 0) const;
...
class irtkFastCubicBSplineInterpolateImageFunction
: public irtkGenericFastCubicBSplineInterpolateImageFunction<irtkBaseImage>
{
  irtkObjectMacro(irtkFastCubicBSplineInterpolateImageFunction);

public:

  /// Constructor
  irtkFastCubicBSplineInterpolateImageFunction() {}
