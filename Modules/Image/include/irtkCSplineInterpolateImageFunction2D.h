...
/**
 * Cubic spline interpolation of generic 2D image
 */

template <class TImage>
class irtkGenericCSplineInterpolateImageFunction2D
: public irtkGenericCSplineInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericCSplineInterpolateImageFunction2D);
...
/**
 * Cubic spline interpolation of any 2D image
 */

class irtkCSplineInterpolateImageFunction2D
: public irtkGenericCSplineInterpolateImageFunction2D<irtkBaseImage>
{
  irtkObjectMacro(irtkCSplineInterpolateImageFunction2D);
