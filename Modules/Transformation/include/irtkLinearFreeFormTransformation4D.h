...
#ifndef _IRTKLINEARFREEFORMTRANSFORMATION4D_H
#define _IRTKLINEARFREEFORMTRANSFORMATION4D_H
...
class irtkLinearFreeFormTransformation4D : public irtkFreeFormTransformation4D
{
  irtkTransformationMacro(irtkLinearFreeFormTransformation4D);

  // ---------------------------------------------------------------------------
  // Types

  typedef irtkGenericLinearInterpolateImageFunction4D<CPImage> Interpolator;
...
public:
  ...
  irtkLinearFreeFormTransformation4D(double, double, double, double,
                                     double, double, double, double,
                                     double, double, double, double,
                                     double *, double *, double *);

  /// Construct free-form transformation for given image domain and lattice spacing
  explicit irtkLinearFreeFormTransformation4D(const irtkImageAttributes &,
                                              double = -1, double = -1, double = -1, double = -1);

  /// Construct free-form transformation for given target image and lattice spacing
  explicit irtkLinearFreeFormTransformation4D(const irtkBaseImage &,
                                              double, double, double, double);

  /// Construct free-form transformation from given B-spline FFD
  explicit irtkLinearFreeFormTransformation4D(const irtkBSplineFreeFormTransformation4D &);

  /// Copy Constructor
  irtkLinearFreeFormTransformation4D(const irtkLinearFreeFormTransformation4D &);

  /// Destructor
  virtual ~irtkLinearFreeFormTransformation4D();
...
// -----------------------------------------------------------------------------
inline void irtkLinearFreeFormTransformation4D
...
// -----------------------------------------------------------------------------
inline bool irtkLinearFreeFormTransformation4D
