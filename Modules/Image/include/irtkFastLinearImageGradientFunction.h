...
#ifndef _IRTKFASTLINEARIMAGEGRADIENTFUNCTION_H
#define _IRTKFASTLINEARIMAGEGRADIENTFUNCTION_H
 ...
 * to the irtkGenericLinearImageGradientFunction is that the resulting finite
...
class irtkGenericFastLinearImageGradientFunction
: public irtkGenericImageGradientFunction<TImage>
{
  irtkGenericGradientInterpolatorMacro(
    irtkGenericFastLinearImageGradientFunction,
...
public:
  ...
  /// Destructor
  virtual ~irtkGenericFastLinearImageGradientFunction();
...
class irtkFastLinearImageGradientFunction
: public irtkGenericFastLinearImageGradientFunction<irtkBaseImage>
{
  irtkObjectMacro(irtkFastLinearImageGradientFunction);

public:

  /// Constructor
  irtkFastLinearImageGradientFunction() {}
