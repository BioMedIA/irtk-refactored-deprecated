...
#ifndef _IRTKLINEARINTERPOLATEIMAGEFUNCTION_HXX
#define _IRTKLINEARINTERPOLATEIMAGEFUNCTION_HXX
...
irtkGenericLinearInterpolateImageFunction<TImage>
...
// -----------------------------------------------------------------------------
template <class TImage>
void irtkGenericLinearInterpolateImageFunction<TImage>::Initialize(bool coeff)
{
...
// -----------------------------------------------------------------------------
template <class TImage>
void irtkGenericLinearInterpolateImageFunction<TImage>
...
// -----------------------------------------------------------------------------
template <class TImage>
inline typename irtkGenericLinearInterpolateImageFunction<TImage>::VoxelType
irtkGenericLinearInterpolateImageFunction<TImage>
...
// -----------------------------------------------------------------------------
template <>
inline typename irtkGenericLinearInterpolateImageFunction<irtkBaseImage>::VoxelType
irtkGenericLinearInterpolateImageFunction<irtkBaseImage>
::GetInside(double x, double y, double z, double t) const
{
