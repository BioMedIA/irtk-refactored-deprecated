...
// -----------------------------------------------------------------------------
irtkMaxStepLineSearch::irtkMaxStepLineSearch(irtkObjectiveFunction *f)
:
...
// -----------------------------------------------------------------------------
irtkMaxStepLineSearch::irtkMaxStepLineSearch(const irtkMaxStepLineSearch &other)
:
...
// -----------------------------------------------------------------------------
irtkMaxStepLineSearch &irtkMaxStepLineSearch::operator =(const irtkMaxStepLineSearch &other)
{
...
// -----------------------------------------------------------------------------
irtkMaxStepLineSearch::~irtkMaxStepLineSearch()
{
}
...
// -----------------------------------------------------------------------------
double irtkMaxStepLineSearch::Run()
{
  ...
  while (iteration.Next()) {
    ...
    if (delta <= _Delta) {
      ...
      if (_Descent ? (value < current - _Epsilon)
        ...
        if (IsNaN(value)) {
          cerr << "irtkMaxStepLineSearch::Run:" << __LINE__ << ": NaN objective function value!" << endl;
          exit(1);
        }
