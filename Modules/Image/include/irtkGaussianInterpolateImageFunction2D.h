...
/**
 * Gaussian interpolation of generic 2D image
 */

template <class TImage>
class irtkGenericGaussianInterpolateImageFunction2D
: public irtkGenericGaussianInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericGaussianInterpolateImageFunction2D);
  irtkGenericInterpolatorTypes(irtkGenericGaussianInterpolateImageFunction);

public:

  /// Default constructor
  irtkGenericGaussianInterpolateImageFunction2D(double sigma = 1.0);
...
/**
 * Gaussian interpolation of any 2D image
 */

class irtkGaussianInterpolateImageFunction2D
: public irtkGenericGaussianInterpolateImageFunction2D<irtkBaseImage>
{
  irtkObjectMacro(irtkGaussianInterpolateImageFunction2D);

public:

  /// Constructor
  irtkGaussianInterpolateImageFunction2D(double sigma)
  :
    irtkGenericGaussianInterpolateImageFunction2D<irtkBaseImage>(sigma)
  {}
