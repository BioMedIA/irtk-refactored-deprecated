...
#ifndef _IRTKCUBICBSPLINEINTERPOLATEIMAGEFUNCTION2D_H
#define _IRTKCUBICBSPLINEINTERPOLATEIMAGEFUNCTION2D_H
...
class irtkGenericCubicBSplineInterpolateImageFunction2D
: public irtkGenericCubicBSplineInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericCubicBSplineInterpolateImageFunction2D);
  irtkGenericInterpolatorTypes(irtkGenericCubicBSplineInterpolateImageFunction);

public:

  /// Default constructor
  irtkGenericCubicBSplineInterpolateImageFunction2D();
...
class irtkCubicBSplineInterpolateImageFunction2D
: public irtkGenericCubicBSplineInterpolateImageFunction2D<irtkBaseImage>
{
  irtkObjectMacro(irtkCubicBSplineInterpolateImageFunction2D);

public:

  /// Constructor
  irtkCubicBSplineInterpolateImageFunction2D() {}
