...
// -----------------------------------------------------------------------------
irtkScalarGaussianDyDz
::irtkScalarGaussianDyDz(double sigma)
:
...
// -----------------------------------------------------------------------------
irtkScalarGaussianDyDz
::irtkScalarGaussianDyDz(double sigma, double x_0, double y_0, double z_0, double t_0)
:
...
// -----------------------------------------------------------------------------
irtkScalarGaussianDyDz
::irtkScalarGaussianDyDz(double sigma_x, double sigma_y, double sigma_z,
...
// -----------------------------------------------------------------------------
irtkScalarGaussianDyDz
::irtkScalarGaussianDyDz(double sigma_x, double sigma_y, double sigma_z, double sigma_t,
...
// -----------------------------------------------------------------------------
double irtkScalarGaussianDyDz::Evaluate(double)
{
  return .0;
}

// -----------------------------------------------------------------------------
double irtkScalarGaussianDyDz::Evaluate(double, double)
{
  return .0;
}
...
double irtkScalarGaussianDyDz::Evaluate(double x, double y, double z)
{
  ...
  return _Norm[2] * exp(- 0.5 * (  (x * x) / _Variance._x
                                 + (y * y) / _Variance._y
                                 + (z * z) / _Variance._z))
         * (y / _Variance._y) * (z / _Variance._z);
}

// -----------------------------------------------------------------------------
double irtkScalarGaussianDyDz::Evaluate(double x, double y, double z, double t)
{
