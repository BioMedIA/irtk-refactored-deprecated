...
#ifndef _IRTKFUZZYCORRESPONDENCE_H
#define _IRTKFUZZYCORRESPONDENCE_H
...
class irtkFuzzyCorrespondence : public irtkPointCorrespondence
{
  irtkAbstractMacro(irtkFuzzyCorrespondence);
...
public:
  ...
  typedef irtkFuzzyCorrespondenceUtils::WeightMatrix WeightMatrix;
...
protected:
  ...
  /// Copy constructor
  irtkFuzzyCorrespondence(const irtkFuzzyCorrespondence &);

public:

  /// Destructor
  virtual ~irtkFuzzyCorrespondence();
