...
#ifndef _IRTKFASTLINEARIMAGEGRADIENTFUNCTION_HXX
#define _IRTKFASTLINEARIMAGEGRADIENTFUNCTION_HXX
...
irtkGenericFastLinearImageGradientFunction<TImage>
...
// -----------------------------------------------------------------------------
template <class TImage>
void irtkGenericFastLinearImageGradientFunction<TImage>::Initialize(bool coeff)
{
...
// -----------------------------------------------------------------------------
template <class TImage>
void irtkGenericFastLinearImageGradientFunction<TImage>
...
// -----------------------------------------------------------------------------
template <class TImage>
inline typename irtkGenericFastLinearImageGradientFunction<TImage>::GradientType
irtkGenericFastLinearImageGradientFunction<TImage>
