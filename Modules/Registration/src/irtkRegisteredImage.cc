...
// -----------------------------------------------------------------------------
template <class Transformer, class Interpolator>
void irtkRegisteredImage::Update3(const blocked_range3d<int> &region,
...
void irtkRegisteredImage::Update2(const blocked_range3d<int> &region,
                                  bool intensity, bool gradient, bool hessian)
{
...
void irtkRegisteredImage::Update1(const blocked_range3d<int> &region,
                                  bool intensity, bool gradient, bool hessian)
{
...
// -----------------------------------------------------------------------------
void irtkRegisteredImage::Update(const blocked_range3d<int> &region,
                                 bool intensity, bool gradient, bool hessian,
                                 bool force)
{
