...
enum irtkHomogeneousTransformationParameterIndex
{
...
{
  irtkTransformationMacro(irtkHomogeneousTransformation);
...
protected:
  ...
  irtkHomogeneousTransformation(int);

  /// Copy constructor with given number of parameters
  irtkHomogeneousTransformation(const irtkHomogeneousTransformation &, int);
...
public:
  ...
  virtual double Approximate(const irtkMatrix &);

  /// Approximate given homogeneous coordinate transformation matrix
  virtual double ApproximateAsNew(const irtkMatrix &);
...
// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::Update(AttributeSelector what)
{
  // Update attributes
  switch (what) {
    case MATRIX:
...
// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::Put(int i, DOFValue x)
{
...
// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::Put(const DOFValue *x)
{
...
// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::Add(const DOFValue *dx)
{
...
// -----------------------------------------------------------------------------
inline double irtkHomogeneousTransformation::Update(const DOFValue *dx)
{
  double delta, max_delta = .0;
  for (int idx = 0; idx < _NumberOfDOFs; ++idx) {
...
// -----------------------------------------------------------------------------
inline const irtkMatrix &irtkHomogeneousTransformation::GetMatrix() const
{
  return _matrix;
}

// -----------------------------------------------------------------------------
inline const irtkMatrix &irtkHomogeneousTransformation::GetInverseMatrix() const
{
  return _inverse;
}

// =============================================================================
// Virtual irtkTransformation "Impl" methods
// =============================================================================

// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::GlobalTransform(double &x, double &y, double &z, double, double) const
{
...
// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::LocalTransform(double &, double &, double &, double, double) const
{
  // No local component
}

// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::Transform(double &x, double &y, double &z, double t, double t0) const
{
  this->GlobalTransform(x, y, z, t, t0);
}

// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::GlobalInverse(double &x, double &y, double &z, double, double) const
{
...
// -----------------------------------------------------------------------------
inline bool irtkHomogeneousTransformation::LocalInverse(double &, double &, double &, double, double) const
{
  // No local component
  return true;
}
...
// -----------------------------------------------------------------------------
inline bool irtkHomogeneousTransformation::Inverse(double &x, double &y, double &z, double t, double t0) const
{
...
// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::GlobalJacobian(irtkMatrix &jac, double, double, double, double, double) const
{
  jac.Initialize(3, 3);
  for (int i = 0; i < 3; i++) {
    for (int j = 0; j < 3; j++) {
...
// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::LocalJacobian(irtkMatrix &jac, double, double, double, double, double) const
{
  jac.Initialize(3, 3);
  jac(0, 0) = 1;
  jac(1, 1) = 1;
...
// -----------------------------------------------------------------------------
inline void irtkHomogeneousTransformation::Jacobian(irtkMatrix &jac, double x, double y, double z, double t, double t0) const
{
