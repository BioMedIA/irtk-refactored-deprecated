 ...
 * irtkBSplineFunction::Initialize();
...
public:
  ...
  IRTKCU_API static TReal Weight(TReal);
  ...
  /// - [2]: t in ]0, 1]
  /// - [3]: t in ]1, 2[
  IRTKCU_API static void Weights(TReal, TReal[4]);
...
template <class TReal>
const TReal irtkBSpline<TReal>::LatticeWeights   [4] = { 1.0/6.0,  2.0/3.0, 1.0/6.0, 0.0};
template <class TReal>
const TReal irtkBSpline<TReal>::LatticeWeights_I [4] = {-0.5,      0.0,     0.5,     0.0};
template <class TReal>
const TReal irtkBSpline<TReal>::LatticeWeights_II[4] = { 1.0,     -2.0,     1.0,     0.0};

// -----------------------------------------------------------------------------
typedef irtkBSpline<double> irtkBSplineFunction;
...
// -----------------------------------------------------------------------------
template <class TReal>
inline void irtkBSpline<TReal>::Weights(TReal t, TReal value[4])
{
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::Weight(TReal t)
{
  TReal value = 0.0;
  t = fabs(t);
  if (t < 2.0) {
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B(TReal t)
{
  return Weight(t);
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B(int i, TReal t)
{
  switch (i) {
    case 0:  return B0(t);
    case 1:  return B1(t);
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B0(TReal t)
{
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B1(TReal t)
{
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B2(TReal t)
{
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B3(TReal t)
{
  return (t*t*t)/6.0;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B_I(TReal t)
{
  TReal y     = fabs(t);
  TReal value = 0.0;
  if (y < 2.0) {
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B_I(int i, TReal t)
{
  switch (i) {
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B0_I(TReal t)
{
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B1_I(TReal t)
{
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B2_I(TReal t)
{
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B3_I(TReal t)
{
  return (t*t)/2.0;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B_II(TReal t)
{
  TReal value = 0.0;
  t = fabs(t);
  if (t < 2.0) {
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B_II(int i, TReal t)
{
  switch (i) {
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B0_II(TReal t)
{
  return 1.0 - t;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B1_II(TReal t)
{
  return 3.0*t - 2.0;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B2_II(TReal t)
{
  return -3.0*t + 1.0;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B3_II(TReal t)
{
  return t;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B_III(TReal t)
{
  TReal y     = fabs(t);
  TReal value = 0.0;
  if (y < 2.0) {
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B_III(int i, TReal t)
{
  switch (i) {
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B0_III(TReal)
{
  return -1.0;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B1_III(TReal)
{
  return 3.0;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B2_III(TReal)
{
  return -3.0;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B3_III(TReal)
{
  return 1.0;
}
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B_nI(int n, TReal t)
{
  switch(n) {
    case 0:  return B    (t);
    case 1:  return B_I  (t);
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B_nI(int i, int n, TReal t)
{
  switch(n) {
    case 0:  return B    (i, t);
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B0_nI(int n, TReal t)
{
  switch(n) {
    case 0:  return B0    (t);
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B1_nI(int n, TReal t)
{
  switch(n) {
    case 0:  return B1    (t);
    case 1:  return B1_I  (t);
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B2_nI(int n, TReal t)
{
  switch(n) {
    case 0:  return B2    (t);
...
// -----------------------------------------------------------------------------
template <class TReal>
inline TReal irtkBSpline<TReal>::B3_nI(int n, TReal t)
{
  switch(n) {
    case 0:  return B3    (t);
...
// -----------------------------------------------------------------------------
template <class TReal>
inline void irtkBSpline<TReal>::Initialize(bool force)
{
...
// -----------------------------------------------------------------------------
template <class TReal>
inline int irtkBSpline<TReal>::VariableToIndex(TReal t)
{
  if      (t <  .0) return 0;
