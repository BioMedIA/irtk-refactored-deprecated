...
// -----------------------------------------------------------------------------
irtkInverseAffineTransformation::irtkInverseAffineTransformation(irtkAffineTransformation *t)
:
  _Transformation(NULL)
{
  _TransformationObserver.Bind(
    ModifiedEvent,
    MakeDelegate(this, &irtkInverseAffineTransformation::OnTransformationChanged)
  );
  Transformation(t);
}

// -----------------------------------------------------------------------------
irtkInverseAffineTransformation::~irtkInverseAffineTransformation()
{
  Transformation(NULL);
}

// -----------------------------------------------------------------------------
void irtkInverseAffineTransformation::Transformation(irtkAffineTransformation *t)
{
...
// -----------------------------------------------------------------------------
bool irtkInverseAffineTransformation::HasSameDOFsAs(const irtkTransformation *t) const
{
  return HaveSameDOFs(_Transformation, t);
}

// -----------------------------------------------------------------------------
void irtkInverseAffineTransformation::OnTransformationChanged()
{
...
// -----------------------------------------------------------------------------
void irtkInverseAffineTransformation::JacobianDOFs(double jac[3], int dof, double x, double y, double z, double, double) const
{
