...
#define _IRTKCSPLINEINTERPOLATEIMAGEFUNCTION_H
...
class irtkGenericCSplineInterpolateImageFunction
...
public:
  ...
  /// Destructor
  virtual ~irtkGenericCSplineInterpolateImageFunction();
...
class irtkCSplineInterpolateImageFunction
: public irtkGenericCSplineInterpolateImageFunction<irtkBaseImage>
{
  irtkObjectMacro(irtkCSplineInterpolateImageFunction);
