...
/**
 * B-spline interpolation of generic 2D image
 */

template <class TImage>
class irtkGenericBSplineInterpolateImageFunction2D
: public irtkGenericBSplineInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericBSplineInterpolateImageFunction2D);
  irtkGenericInterpolatorTypes(irtkGenericBSplineInterpolateImageFunction);

public:

  /// Default constructor
  irtkGenericBSplineInterpolateImageFunction2D();
...
/**
 * B-spline interpolation of any 2D image
 */

class irtkBSplineInterpolateImageFunction2D
: public irtkGenericBSplineInterpolateImageFunction2D<irtkBaseImage>
{
  irtkObjectMacro(irtkBSplineInterpolateImageFunction2D);
