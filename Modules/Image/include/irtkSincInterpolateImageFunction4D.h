...
#ifndef _IRTKSINCINTERPOLATEIMAGEFUNCTION4D_H
#define _IRTKSINCINTERPOLATEIMAGEFUNCTION4D_H

#include <irtkSincInterpolateImageFunction.h>


/**
 * Sinc interpolation of generic 4D image
 */

template <class TImage>
class irtkGenericSincInterpolateImageFunction4D
: public irtkGenericSincInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericSincInterpolateImageFunction4D);
  irtkGenericInterpolatorTypes(irtkGenericSincInterpolateImageFunction);
...
/**
 * Sinc interpolation of any 4D image
 */

class irtkSincInterpolateImageFunction4D
: public irtkGenericSincInterpolateImageFunction4D<irtkBaseImage>
{
  irtkObjectMacro(irtkSincInterpolateImageFunction4D);

public:

  /// Constructor
  irtkSincInterpolateImageFunction4D() {}
