...
// -----------------------------------------------------------------------------
irtkScalarGaussianDx
::irtkScalarGaussianDx(double sigma)
:
...
// -----------------------------------------------------------------------------
irtkScalarGaussianDx
::irtkScalarGaussianDx(double sigma, double x_0, double y_0, double z_0, double t_0)
:
...
// -----------------------------------------------------------------------------
irtkScalarGaussianDx
::irtkScalarGaussianDx(double sigma_x, double sigma_y, double sigma_z,
...
// -----------------------------------------------------------------------------
irtkScalarGaussianDx
::irtkScalarGaussianDx(double sigma_x, double sigma_y, double sigma_z, double sigma_t,
...
// -----------------------------------------------------------------------------
double irtkScalarGaussianDx::Evaluate(double x)
{
  x -= _Center._x;
  return _Norm[0] * exp(- 0.5 * (x * x) / _Variance._x) * (-x / _Variance._x);
}

// -----------------------------------------------------------------------------
double irtkScalarGaussianDx::Evaluate(double x, double y)
{
  x -= _Center._x, y -= _Center._y;
  return _Norm[1] * exp(- 0.5 * (  (x * x) / _Variance._x
                                 + (y * y) / _Variance._y)) * (-x / _Variance._x);
}
...
double irtkScalarGaussianDx::Evaluate(double x, double y, double z)
{
  ...
  return _Norm[2] * exp(- 0.5 * (  (x * x) / _Variance._x
                                 + (y * y) / _Variance._y
                                 + (z * z) / _Variance._z)) * (-x / _Variance._x);
}

// -----------------------------------------------------------------------------
double irtkScalarGaussianDx::Evaluate(double x, double y, double z, double t)
{
  x -= _Center._x, y -= _Center._y, z -= _Center._z, t -= _Center._t;
  return _Norm[3] * exp(- 0.5 * (  (x * x) / _Variance._x
                                 + (y * y) / _Variance._y
                                 + (z * z) / _Variance._z
                                 + (t * t) / _Variance._t)) * (-x / _Variance._x);
}
