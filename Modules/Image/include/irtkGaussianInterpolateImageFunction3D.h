...
#ifndef _IRTKGAUSSIANINTERPOLATEIMAGEFUNCTION3D_H
#define _IRTKGAUSSIANINTERPOLATEIMAGEFUNCTION3D_H
...
class irtkGenericGaussianInterpolateImageFunction3D
: public irtkGenericGaussianInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericGaussianInterpolateImageFunction3D);
  irtkGenericInterpolatorTypes(irtkGenericGaussianInterpolateImageFunction);

public:

  /// Default constructor
  irtkGenericGaussianInterpolateImageFunction3D(double sigma = 1.0);
...
class irtkGaussianInterpolateImageFunction3D
: public irtkGenericGaussianInterpolateImageFunction3D<irtkBaseImage>
{
  irtkObjectMacro(irtkGaussianInterpolateImageFunction3D);


public:

  /// Constructor
  irtkGaussianInterpolateImageFunction3D(double sigma)
  :
    irtkGenericGaussianInterpolateImageFunction3D<irtkBaseImage>(sigma)
  {}
