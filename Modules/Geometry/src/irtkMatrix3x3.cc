...
//----------------------------------------------------------------------------
irtkMatrix3x3::irtkMatrix3x3 (int v)
{
  m_aafEntry[0][0] = v;
  m_aafEntry[0][1] = v;
  m_aafEntry[0][2] = v;
...
//----------------------------------------------------------------------------
irtkMatrix3x3::irtkMatrix3x3 (double v)
{
  m_aafEntry[0][0] = v;
  m_aafEntry[0][1] = v;
  m_aafEntry[0][2] = v;
...
//----------------------------------------------------------------------------
const double* irtkMatrix3x3::operator[] (int iRow) const
{
  return m_aafEntry[iRow];
}
//----------------------------------------------------------------------------
double* irtkMatrix3x3::operator[] (int iRow)
{
  return m_aafEntry[iRow];
}
//----------------------------------------------------------------------------
...
irtkVector3 irtkMatrix3x3::GetColumn (int iCol) const
{
  ...
  return irtkVector3(m_aafEntry[0][iCol],
                     m_aafEntry[1][iCol],
                     m_aafEntry[2][iCol]);
}
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
irtkMatrix3x3& irtkMatrix3x3::operator= (double v)
{
  m_aafEntry[0][0] = v;
  m_aafEntry[0][1] = v;
  m_aafEntry[0][2] = v;
...
//----------------------------------------------------------------------------
irtkMatrix3x3 &irtkMatrix3x3::operator+=(double fScalar)
{
