...
#ifndef _IRTKBSPLINEINTERPOLATEIMAGEFUNCTION3D_H
#define _IRTKBSPLINEINTERPOLATEIMAGEFUNCTION3D_H

#include <irtkBSplineInterpolateImageFunction.h>


/**
 * B-spline interpolation of generic 3D image
 */

template <class TImage>
class irtkGenericBSplineInterpolateImageFunction3D
: public irtkGenericBSplineInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericBSplineInterpolateImageFunction3D);
  irtkGenericInterpolatorTypes(irtkGenericBSplineInterpolateImageFunction);

public:

  /// Default constructor
  irtkGenericBSplineInterpolateImageFunction3D();
...
/**
 * B-spline interpolation of any 3D image
 */

class irtkBSplineInterpolateImageFunction3D
: public irtkGenericBSplineInterpolateImageFunction3D<irtkBaseImage>
{
  irtkObjectMacro(irtkBSplineInterpolateImageFunction3D);

public:

  /// Constructor
  irtkBSplineInterpolateImageFunction3D() {}
