...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation4D::irtkLinearFreeFormTransformation4D()
:
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation4D
::irtkLinearFreeFormTransformation4D(double x1, double y1, double z1, double t1,
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation4D
::irtkLinearFreeFormTransformation4D(const irtkImageAttributes &attr,
                                     double dx, double dy, double dz, double dt)
:
  irtkFreeFormTransformation4D(_FFD)
{
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation4D
::irtkLinearFreeFormTransformation4D(const irtkBaseImage &target,
                                     double dx, double dy, double dz, double dt)
:
  irtkFreeFormTransformation4D(_FFD)
{
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation4D
::irtkLinearFreeFormTransformation4D(const irtkLinearFreeFormTransformation4D &ffd)
:
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation4D
::irtkLinearFreeFormTransformation4D(const irtkBSplineFreeFormTransformation4D &ffd)
:
  irtkFreeFormTransformation4D(ffd, _FFD)
{
  if (_NumberOfDOFs > 0) InitializeInterpolator();
...
// -----------------------------------------------------------------------------
void irtkLinearFreeFormTransformation4D
...
// -----------------------------------------------------------------------------
int irtkLinearFreeFormTransformation4D::KernelSize() const
{
  return 2;
}
...
double irtkLinearFreeFormTransformation4D::BendingEnergy(int i, int j, int k, int l) const
{
...
// -----------------------------------------------------------------------------
double irtkLinearFreeFormTransformation4D::BendingEnergy(bool incl_passive, bool) const
{
  int    nactive = 0;
  double bending = .0;
...
void irtkLinearFreeFormTransformation4D::BendingEnergyGradient(double *gradient, double weight, bool incl_passive, bool) const
{
...
// -----------------------------------------------------------------------------
void irtkLinearFreeFormTransformation4D::Print(irtkIndent indent) const
{
...
// -----------------------------------------------------------------------------
bool irtkLinearFreeFormTransformation4D::CanRead(irtkTransformationType format) const
{
  switch (format) {
