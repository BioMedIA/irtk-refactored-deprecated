...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation3D::irtkLinearFreeFormTransformation3D()
:
  irtkFreeFormTransformation3D(_FFD)
{
}

// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation3D
::irtkLinearFreeFormTransformation3D(double x1, double y1, double z1,
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation3D
::irtkLinearFreeFormTransformation3D(const irtkImageAttributes &attr,
                                     double dx, double dy, double dz)
:
  irtkFreeFormTransformation3D(_FFD)
{
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation3D
::irtkLinearFreeFormTransformation3D(const irtkBaseImage &target,
                                     double dx, double dy, double dz)
:
  irtkFreeFormTransformation3D(_FFD)
{
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation3D
::irtkLinearFreeFormTransformation3D(const irtkGenericImage<double> &image, bool disp)
:
  irtkFreeFormTransformation3D(_FFD)
{
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation3D
::irtkLinearFreeFormTransformation3D(const irtkLinearFreeFormTransformation3D &ffd)
:
  irtkFreeFormTransformation3D(ffd, _FFD)
{
...
// -----------------------------------------------------------------------------
irtkLinearFreeFormTransformation3D
::irtkLinearFreeFormTransformation3D(const irtkBSplineFreeFormTransformation3D &ffd)
:
  irtkFreeFormTransformation3D(ffd, _FFD)
{
  if (_NumberOfDOFs > 0) InitializeInterpolator();
...
// -----------------------------------------------------------------------------
void irtkLinearFreeFormTransformation3D
...
// -----------------------------------------------------------------------------
int irtkLinearFreeFormTransformation3D::KernelSize() const
{
  return 2;
}
...
double irtkLinearFreeFormTransformation3D::BendingEnergy(int i, int j, int k) const
{
...
// -----------------------------------------------------------------------------
double irtkLinearFreeFormTransformation3D::BendingEnergy(bool incl_passive, bool) const
{
  int    nactive = 0;
  double bending = .0;
...
void irtkLinearFreeFormTransformation3D::BendingEnergyGradient(double *gradient, double weight, bool incl_passive, bool) const
{
...
// -----------------------------------------------------------------------------
void irtkLinearFreeFormTransformation3D::Print(irtkIndent indent) const
{
...
// -----------------------------------------------------------------------------
bool irtkLinearFreeFormTransformation3D::CanRead(irtkTransformationType format) const
{
  switch (format) {
...
// -----------------------------------------------------------------------------
void irtkLinearFreeFormTransformation3D::Compose(const irtkTransformation *t1)
{
  // Copy transformation
  irtkLinearFreeFormTransformation3D t2(*this);
