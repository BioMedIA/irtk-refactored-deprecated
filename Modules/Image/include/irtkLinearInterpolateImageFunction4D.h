...
#ifndef _IRTKLINEARINTERPOLATEIMAGEFUNCTION4D_H
#define _IRTKLINEARINTERPOLATEIMAGEFUNCTION4D_H
...
class irtkGenericLinearInterpolateImageFunction4D
: public irtkGenericLinearInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericLinearInterpolateImageFunction4D);
...
class irtkLinearInterpolateImageFunction4D
: public irtkGenericLinearInterpolateImageFunction4D<irtkBaseImage>
{
  irtkObjectMacro(irtkLinearInterpolateImageFunction4D);

public:

  /// Constructor
  irtkLinearInterpolateImageFunction4D() {}
