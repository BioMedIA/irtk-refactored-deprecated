...
#ifndef _IRTKFASTCUBICBSPLINEINTERPOLATEIMAGEFUNCTION4D_H
#define _IRTKFASTCUBICBSPLINEINTERPOLATEIMAGEFUNCTION4D_H

#include <irtkFastCubicBSplineInterpolateImageFunction.h>


/**
 * Fast cubic B-spline interpolation of generic 4D image
 */

template <class TImage>
class irtkGenericFastCubicBSplineInterpolateImageFunction4D
: public irtkGenericFastCubicBSplineInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericFastCubicBSplineInterpolateImageFunction4D);
...
/**
 * Fast cubic B-spline interpolation of any 4D image
 */

class irtkFastCubicBSplineInterpolateImageFunction4D
: public irtkGenericFastCubicBSplineInterpolateImageFunction4D<irtkBaseImage>
{
  irtkObjectMacro(irtkFastCubicBSplineInterpolateImageFunction4D);

public:

  /// Constructor
  irtkFastCubicBSplineInterpolateImageFunction4D() {}
