...
#ifndef _IRTKLINEARIMAGEGRADIENTFUNCTION3D_H
#define _IRTKLINEARIMAGEGRADIENTFUNCTION3D_H
...
class irtkGenericLinearImageGradientFunction3D
: public irtkGenericLinearImageGradientFunction<TImage>
{
  irtkObjectMacro(irtkGenericLinearImageGradientFunction3D);
...
class irtkLinearImageGradientFunction3D
: public irtkGenericLinearImageGradientFunction3D<irtkBaseImage>
{
  irtkObjectMacro(irtkLinearImageGradientFunction3D);

public:

  /// Constructor
  irtkLinearImageGradientFunction3D() {}
