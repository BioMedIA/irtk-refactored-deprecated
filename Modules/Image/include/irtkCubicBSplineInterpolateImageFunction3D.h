...
#ifndef _IRTKCUBICBSPLINEINTERPOLATEIMAGEFUNCTION3D_H
#define _IRTKCUBICBSPLINEINTERPOLATEIMAGEFUNCTION3D_H

#include <irtkCubicBSplineInterpolateImageFunction.h>


/**
 * Cubic B-spline interpolation of generic 3D image
 */

template <class TImage>
class irtkGenericCubicBSplineInterpolateImageFunction3D
: public irtkGenericCubicBSplineInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericCubicBSplineInterpolateImageFunction3D);
  irtkGenericInterpolatorTypes(irtkGenericCubicBSplineInterpolateImageFunction);

public:

  /// Default constructor
  irtkGenericCubicBSplineInterpolateImageFunction3D();
...
/**
 * Cubic B-spline interpolation of any 3D image
 */

class irtkCubicBSplineInterpolateImageFunction3D
: public irtkGenericCubicBSplineInterpolateImageFunction3D<irtkBaseImage>
{
  irtkObjectMacro(irtkCubicBSplineInterpolateImageFunction3D);

public:

  /// Constructor
  irtkCubicBSplineInterpolateImageFunction3D() {}
