...
// Static assertion which does not cause GCC >=4.8 issue a unused local typedef warning
...
inline OutputClass horrible_cast(const InputClass input){
	...
	StaticAssert<sizeof(InputClass)==sizeof(u) && sizeof(InputClass)==sizeof(OutputClass)> ERROR_CantUseHorrible_cast;
	u.in = input;
	return u.out;
}
...
struct SimplifyMemFunc {
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind, 
		...
		StaticAssert<N-100> ERROR_Unsupported_member_function_pointer_on_this_compiler;
		return 0; 
	}
};
...
struct SimplifyMemFunc< SINGLE_MEMFUNCPTR_SIZE + sizeof(int) >  {
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind, 
		...
		StaticAssert<sizeof(function_to_bind)==sizeof(u.s)> ERROR_CantUseHorrible_cast;
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 2*sizeof(int) >
{
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind, 
		...
		StaticAssert<sizeof(function_to_bind)==sizeof(u.s)
			&& sizeof(function_to_bind)==sizeof(u.ProbeFunc)
			&& sizeof(u2.virtfunc)==sizeof(u2.s)> ERROR_CantUseHorrible_cast;
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3*sizeof(int) >
{
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind, 
		...
		StaticAssert<-100> ERROR_VC6CompilerBug;
		return 0; 
	}
};
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3*sizeof(int) >
{
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind, 
		...
		// Check that the horrible_cast will work
		StaticAssert<sizeof(XFuncType)==sizeof(u.s)> ERROR_CantUseHorrible_cast;
		u.func = function_to_bind;
		bound_func = u.s.funcaddress;
		int virtual_delta = 0;
...
// support static_cast between void * and function pointers.
	...
	inline void bindstaticfunc(DerivedClass *pParent, ParentInvokerSig static_function_invoker, 
		...
		StaticAssert<sizeof(GenericClass *)==sizeof(function_to_bind)> ERROR_CantUseEvilMethod;
...
//		m_pthis = reinterpret_cast<GenericClass *>(reinterpret_cast<long>(function_to_bind));
	...
	inline UnvoidStaticFuncPtr GetStaticFunction() const {
		...
		// and data pointers have different sizes.
		// If you get this error, you need to #undef FASTDELEGATE_USESTATICFUNCTIONHACK.
		StaticAssert<sizeof(UnvoidStaticFuncPtr)==sizeof(this)> ERROR_CantUseEvilMethod;
