...
struct GlobalInverseTransformFunctor
{
  ...
  GlobalInverseTransformFunctor(const irtkTransformation * transformation,
  ...
  const irtkTransformation * transformation_;
  double x_;
  double y_;
  double z_;
  double t_;
...
// -----------------------------------------------------------------------------
bool EvaluateGlobalInverse(const irtkTransformation *T,
                           double &x, double &y, double &z, double t, double t0)
{
...
struct LocalInverseTransformFunctor
{
  ...
  LocalInverseTransformFunctor(const irtkTransformation * transformation,
    double x, double y, double z, double t, double t0)
    : transformation_(transformation), x_(x), y_(y), z_(z), t_(t), t0_(t0)
  {
  }
...
// -----------------------------------------------------------------------------
bool EvaluateLocalInverse(const irtkTransformation *T,
                          double &x, double &y, double &z, double t, double t0)
{
  using namespace boost::math::tools;
...
struct InverseTransformFunctor
{
  ...
  InverseTransformFunctor(const irtkTransformation * transformation,
    double x, double y, double z, double t, double t0)
    : transformation_(transformation), x_(x), y_(y), z_(z), t_(t), t0_(t0)
  {
  }
...
// -----------------------------------------------------------------------------
bool EvaluateInverse(const irtkTransformation *T,
                     double &x, double &y, double &z, double t, double t0)
{
  using namespace boost::math::tools;
...
struct InverseMultiLevelTransformFunctor
{
  ...
  InverseMultiLevelTransformFunctor(const irtkMultiLevelTransformation * transformation,
  ...
  const irtkMultiLevelTransformation * transformation_;
  double x_;
  double y_;
  double z_;
  int m_;
...
// -----------------------------------------------------------------------------
bool EvaluateInverse(const irtkMultiLevelTransformation *T, int m, int n,
                     double &x, double &y, double &z, double t, double t0)
{
  using namespace boost::math::tools;
