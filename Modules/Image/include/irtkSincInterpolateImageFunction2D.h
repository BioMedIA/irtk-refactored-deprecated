...
/**
 * Sinc interpolation of generic 2D image
 */

template <class TImage>
class irtkGenericSincInterpolateImageFunction2D
: public irtkGenericSincInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericSincInterpolateImageFunction2D);
...
/**
 * Sinc interpolation of any 2D image
 */

class irtkSincInterpolateImageFunction2D
: public irtkGenericSincInterpolateImageFunction2D<irtkBaseImage>
{
  irtkObjectMacro(irtkSincInterpolateImageFunction2D);
