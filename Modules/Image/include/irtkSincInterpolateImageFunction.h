...
class irtkGenericSincInterpolateImageFunction
...
class irtkSincInterpolateImageFunction
: public irtkGenericSincInterpolateImageFunction<irtkBaseImage>
{
  irtkObjectMacro(irtkSincInterpolateImageFunction);
