...
:
  irtkGaussianBlurring<VoxelType>(sigma, sigma, sigma, sigma)
{
}

template <class VoxelType> irtkGaussianBlurring4D<VoxelType>::irtkGaussianBlurring4D(double xsigma, double ysigma, double zsigma, double tsigma)
:
  irtkGaussianBlurring<VoxelType>(xsigma, ysigma, zsigma, tsigma)
{
}

template <class VoxelType> irtkGaussianBlurring4D<VoxelType>::~irtkGaussianBlurring4D()
{
}
