...
#ifndef _IRTKTERNARYVOXELFUNCTION_H
#define _IRTKTERNARYVOXELFUNCTION_H
 ...
 */
struct Sum : public irtkVoxelFunction
{
 ...
 */
struct Diff : public irtkVoxelFunction
{
  template <class T1, class T2, class T3>
  void operator ()(const T1 *in1, const T2 *in2, T3 *out)
  {
