...
#ifndef _IRTKFASTCUBICBSPLINEINTERPOLATEIMAGEFUNCTION3D_H
#define _IRTKFASTCUBICBSPLINEINTERPOLATEIMAGEFUNCTION3D_H
...
class irtkGenericFastCubicBSplineInterpolateImageFunction3D
: public irtkGenericFastCubicBSplineInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericFastCubicBSplineInterpolateImageFunction3D);
...
class irtkFastCubicBSplineInterpolateImageFunction3D
: public irtkGenericFastCubicBSplineInterpolateImageFunction3D<irtkBaseImage>
{
  irtkObjectMacro(irtkFastCubicBSplineInterpolateImageFunction3D);

public:

  /// Constructor
  irtkFastCubicBSplineInterpolateImageFunction3D() {}
