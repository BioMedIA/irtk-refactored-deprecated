...
#ifndef _IRTKTRIANGLE_H
#define _IRTKTRIANGLE_H
...
#define RETURN_POINT(a, b) if (a) memcpy((a), (b), 3 * sizeof(double))
...
// Journal of Graphics Tools, 2(2), 1997
#define NoDivTriTriIsect_USE_EPSILON_TEST 0
int NoDivTriTriIsect(const double V0[3], const double V1[3], const double V2[3],
                     const double U0[3], const double U1[3], const double U2[3])
{
#if NoDivTriTriIsect_USE_EPSILON_TEST
...
#undef NoDivTriTriIsect_USE_EPSILON_TEST
...
int tr_tri_intersect3D(const double *C1, const double *C2, const double *C3, const double *P1, const double *P2,
                               ...
                               const double d1[3], const double d2[3], const double d3[3])
{
  ...
  return tr_tri_intersect3D(c1, c2, c3, p1, p2, d1, d2, d3, q1, q2);
}
...
{
  double n1[3], n2[3];
  vtkTriangle::ComputeNormal(const_cast<double *>(a1), const_cast<double *>(b1), const_cast<double *>(c1), n1);
  vtkTriangle::ComputeNormal(const_cast<double *>(a2), const_cast<double *>(b2), const_cast<double *>(c2), n2);
