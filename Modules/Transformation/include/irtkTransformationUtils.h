...
#ifndef _IRTKTRANSFORMATIONUTILS_H
#define _IRTKTRANSFORMATIONUTILS_H


namespace irtkTransformationUtils {


// -----------------------------------------------------------------------------
/// Parallel helper for irtkTransformation::Approximate implementations
...
public:
  ...
  SubDisplacements(const irtkTransformation *transformation,
...
// -----------------------------------------------------------------------------
/// Body of irtkTransformation::Transform(int, double *, double *, double *, ...)
...
public:
  ...
  TransformPoints(const irtkTransformation *transformation, double *x, double *y, double *z, double t, double t0)
  :
    _Transformation(transformation),
    _x(x), _y(y), _z(z), _t0(t0), _t1(t), _t(NULL)
  {}

  TransformPoints(const irtkTransformation *transformation, double *x, double *y, double *z, const double *t, double t0)
  :
    _Transformation(transformation),
...
// -----------------------------------------------------------------------------
/// Body of irtkTransformation::Transform(irtkWorldCoordsImage &)
class TransformWorldCoords
{
  const irtkTransformation *_Transformation;
  irtkWorldCoordsImage     *_Coords;
  const int                 _NumberOfPoints;
  double _t, _t0;

public:

  TransformWorldCoords(const irtkTransformation *t, irtkWorldCoordsImage &coords, double t0)
  :
    _Transformation(t),
    _Coords(&coords),
  ...
  void operator ()(const blocked_range<int> &idx) const
  {
    irtkWorldCoordsImage::VoxelType *wx, *wy, *wz;
