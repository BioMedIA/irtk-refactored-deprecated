...
{
  irtkTransformationMacro(irtkBSplineFreeFormTransformation3D);
  ...
  /// \todo Remove once irtkBSplineFreeFormTransformation2D is implemented.
  typedef irtkGenericFastCubicBSplineInterpolateImageFunction2D<CPImage> Interpolator2D;

public:

  typedef irtkGenericFastCubicBSplineInterpolateImageFunction3D<CPImage> Interpolator;
...
public:
  ...
  irtkBSplineFreeFormTransformation3D(double, double, double,
                                      double, double, double,
                                      double, double, double,
                                      double *, double *, double *);

  /// Construct free-form transformation for given image domain and lattice spacing
  explicit irtkBSplineFreeFormTransformation3D(const irtkImageAttributes &,
                                               double = -1, double = -1, double = -1);

  /// Construct free-form transformation for given target image and lattice spacing
  explicit irtkBSplineFreeFormTransformation3D(const irtkBaseImage &,
                                               double, double, double);

  /// Construct free-form transformation from existing 3D+t deformation field
  explicit irtkBSplineFreeFormTransformation3D(const irtkGenericImage<double> &, bool = false);

  /// Copy Constructor
  irtkBSplineFreeFormTransformation3D(const irtkBSplineFreeFormTransformation3D &);
  ...
  using irtkFreeFormTransformation3D::BoundingBox;
  ...
  void EvaluateJacobian(irtkMatrix &, int, int) const;

  /// Calculates the Jacobian of the FFD at a point in lattice coordinates
  void EvaluateJacobian(irtkMatrix &, int, int, int) const;

  /// Calculates the Jacobian of the FFD at a point in lattice coordinates
  void EvaluateJacobian(irtkMatrix &, double, double) const;
  ...
  void EvaluateJacobianWorld(irtkMatrix &, double, double) const;

  /// Calculates the Jacobian of the FFD at a point in lattice coordinates
  /// and converts the resulting Jacobian to derivatives w.r.t world coordinates
  void EvaluateJacobianWorld(irtkMatrix &, double, double, double) const;
  ...
  void EvaluateDerivativeOfJacobianWrtDOF(irtkMatrix &, int, double, double) const;

  /// Calculates the derivative of the Jacobian of the FFD at a point in lattice coordinates
  /// w.r.t a transformation parameter
  void EvaluateDerivativeOfJacobianWrtDOF(irtkMatrix &, int, double, double, double) const;

  /// Calculates the Hessian of the 2D FFD at a point in lattice coordinates
  void EvaluateHessian(irtkMatrix [3], int, int) const;

  /// Calculates the Hessian of the 2D FFD at a point in lattice coordinates
  void EvaluateHessian(irtkMatrix [3], double, double) const;

  /// Calculates the Hessian of the FFD at a point in lattice coordinates
  void EvaluateHessian(irtkMatrix [3], int, int, int) const;

  /// Calculates the Hessian of the FFD at a point in lattice coordinates
  void EvaluateHessian(irtkMatrix [3], double, double, double) const;
  ...
  using irtkFreeFormTransformation3D::LocalHessian;
  ...
  virtual void JacobianDetDerivative(irtkMatrix *, int, int, int) const;
...
public:
  ...
  /// \deprecated Use irtkBSpline<double>::B(double) instead.
  static double B(double t) { return Kernel::B(t); }

  /// \deprecated Use irtkBSpline<double>::B(int, double) instead.
  static double B(int i, double t) { return Kernel::B(i, t); }

  /// Evaluates the displacement with control point values outside the
  /// control point lattice set to zero as used by nreg and nreg2.
  /// \deprecated Use Evaluate(double &, double &) instead.
  void FFD2D(double &x, double &y) const;

  /// Evaluates the displacement with control point values outside the
  /// control point lattice set to zero as used by nreg and nreg2.
  /// \deprecated Use Evaluate(double &, double &, double &) instead.
  void FFD3D(double &x, double &y, double &z) const;

  /// Calculates the bending energy as used by nreg and nreg2.
  /// \deprecated Use BendingEnergy(double, double, double, double, double) instead.
  double Bending(double, double, double) const;

  /// Calculates the bending energy as used by nreg and nreg2.
  /// \deprecated Use BendingEnergy(bool) instead.
  double Bending() const;

  /// Calculates the gradient of the bending energy as used by nreg2.
  /// \deprecated Use BendingEnergyGradient instead.
  void BendingGradient(double *) const;

protected:

  /// Calculates the bending energy as used by nreg and nreg2.
  /// \deprecated Use BendingEnergy(double, double, double, double, double) instead.
  double _Bending2D(int, int) const;

  /// Calculates the bending energy as used by nreg and nreg2.
  /// \deprecated Use BendingEnergy(double, double, double, double, double) instead.
  double _Bending2D(double, double) const;

  /// Calculates the bending energy as used by nreg and nreg2.
  /// \deprecated Use BendingEnergy(double, double, double, double, double) instead.
  double _Bending3D(int, int, int) const;

  /// Calculates the bending energy as used by nreg and nreg2.
  /// \deprecated Use BendingEnergy(double, double, double, double, double) instead.
  double _Bending3D(double, double, double) const;

  /// Calculates the gradient of the bending energy as used by nreg2.
  /// \deprecated Use BendingEnergyGradient instead.
  void _BendingGradient2D(double *) const;

  /// Calculates the gradient of the bending energy as used by nreg2.
  /// \deprecated Use BendingEnergyGradient instead.
  void _BendingGradient3D(double *) const;
...
// -----------------------------------------------------------------------------
inline void irtkBSplineFreeFormTransformation3D
...
// -----------------------------------------------------------------------------
inline void irtkBSplineFreeFormTransformation3D
::EvaluateJacobianWorld(irtkMatrix &jac, double x, double y) const
{
...
// -----------------------------------------------------------------------------
inline void irtkBSplineFreeFormTransformation3D
::EvaluateJacobianWorld(irtkMatrix &jac, double x, double y, double z) const
{
  // Compute 1st order derivatives
...
// -----------------------------------------------------------------------------
inline void irtkBSplineFreeFormTransformation3D
::EvaluateDerivativeOfJacobianWrtDOF(irtkMatrix &dJdp, int dof, double x, double y) const
{
...
// -----------------------------------------------------------------------------
inline void irtkBSplineFreeFormTransformation3D
::EvaluateDerivativeOfJacobianWrtDOF(irtkMatrix &dJdp, int dof, double x, double y, double z) const
{
  const int dim = this->DOFToDimension(dof);
...
// -----------------------------------------------------------------------------
inline void irtkBSplineFreeFormTransformation3D::FFDJacobianWorld(irtkMatrix &jac, double x, double y, double z, double, double) const
{
  // Convert to lattice coordinates
...
// -----------------------------------------------------------------------------
inline void irtkBSplineFreeFormTransformation3D::LocalJacobian(irtkMatrix &jac, double x, double y, double z, double t, double t0) const
{
  irtkBSplineFreeFormTransformation3D::FFDJacobianWorld(jac, x, y, z, t, t0);
}

// -----------------------------------------------------------------------------
inline void irtkBSplineFreeFormTransformation3D::LocalHessian(irtkMatrix hessian[3], double x, double y, double z, double, double) const
{
  // Convert to lattice coordinates
  this->WorldToLattice(x, y, z);
...
// -----------------------------------------------------------------------------
inline void irtkBSplineFreeFormTransformation3D
::DeriveJacobianWrtDOF(irtkMatrix &dJdp, int dof, double x, double y, double z, double, double) const
{
  // Convert point to lattice coordinates
  this->WorldToLattice(x, y, z);
  // Evaluate derivatives w.r.t. transformation parameters
