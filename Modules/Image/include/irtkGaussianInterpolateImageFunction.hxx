...
#ifndef _IRTKGAUSSIANINTERPOLATEIMAGEFUNCTION_HXX
#define _IRTKGAUSSIANINTERPOLATEIMAGEFUNCTION_HXX
...
irtkGenericGaussianInterpolateImageFunction<TImage>
::irtkGenericGaussianInterpolateImageFunction(double sigma)
:
  _Sigma(sigma),
...
// -----------------------------------------------------------------------------
template <class TImage>
void irtkGenericGaussianInterpolateImageFunction<TImage>::Initialize(bool coeff)
{
...
// -----------------------------------------------------------------------------
template <class TImage>
void irtkGenericGaussianInterpolateImageFunction<TImage>
...
// -----------------------------------------------------------------------------
template <class TImage>
inline typename irtkGenericGaussianInterpolateImageFunction<TImage>::VoxelType
irtkGenericGaussianInterpolateImageFunction<TImage>
::Get2D(double x, double y, double z, double t) const
{
  ...
  irtkScalarGaussian kernel(_Sigma/_dx, _Sigma/_dy, .0, x, y, .0);
...
::Get3D(double x, double y, double z, double t) const
{
  ...
  // Create Gaussian interpolation kernel
  irtkScalarGaussian kernel(_Sigma/_dx, _Sigma/_dy, _Sigma/_dz, x, y, z);
...
::Get4D(double x, double y, double z, double t) const
{
  ...
  // Create Gaussian interpolation kernel
  irtkScalarGaussian kernel(_Sigma/_dx, _Sigma/_dy, _Sigma/_dz, _Sigma/_dt, x, y, z, t);
