...
class irtkGenericNearestNeighborInterpolateImageFunction
...
public:
  ...
  /// Destructor
  virtual ~irtkGenericNearestNeighborInterpolateImageFunction();
...
class irtkNearestNeighborInterpolateImageFunction
      : public irtkGenericNearestNeighborInterpolateImageFunction<irtkBaseImage>
{
  irtkObjectMacro(irtkNearestNeighborInterpolateImageFunction);
