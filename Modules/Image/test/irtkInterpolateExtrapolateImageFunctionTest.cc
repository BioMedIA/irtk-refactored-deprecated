...
irtkGenericImage<VoxelType> *create_test_image(int x = 16, int y = 16, int z = 1, int t = 1, int n = 1)
{
  // Instantiate image
  irtkGenericImage<VoxelType> *image = new irtkGenericImage<double>(x, y, z, t, n);
  // Fill test image
...
int test_Initialize()
{
  ...
  irtkGenericImage<double>     *image = create_test_image<double>(16, 16);
  irtkInterpolateImageFunction *inter = irtkInterpolateImageFunction::New(Interpolation_NN, Extrapolation_Const, image);
  irtkExtrapolateImageFunction *extra = inter->Extrapolator();
...
int test_IsInsideOutside()
{
  ...
  irtkGenericImage<double>     *image = NULL;
  irtkInterpolateImageFunction *inter = NULL;
  //irtkExtrapolateImageFunction *extra = NULL;

  // --------------------------------------------------------------------------
  // 2D
  image = create_test_image<double>(16, 16);
  inter = irtkInterpolateImageFunction::New(Interpolation_NN, Extrapolation_Const, image);
...
int test_Interpolation_NN_Extrapolation_Default()
{
  ...
  irtkGenericImage<double>     *image = create_test_image<double>(16, 16, 16);
  irtkInterpolateImageFunction *func  = irtkInterpolateImageFunction::New(Interpolation_NN, image);
  ...
  ASSERT_STREQUAL(func->NameOfClass(), "irtkGenericNearestNeighborInterpolateImageFunction", "Type of interpolator");
  ASSERT_STREQUAL(func->Extrapolator()->NameOfClass(), "irtkGenericConstExtrapolateImageFunction", "Type of extrapolator");
...
int test_Interpolation_NN_Extrapolation_Const()
{
  ...
  irtkGenericImage<double>     *image = NULL;
  irtkInterpolateImageFunction *func  = NULL;

  // -------------------------------------------------------------------------
  // 2D
  image = create_test_image<double>(16, 16);
  func  = irtkInterpolateImageFunction::New(Interpolation_NN, Extrapolation_Const, image);
...
int test_Interpolation_Linear_Extrapolation_Const()
{
  ...
  // 2D
  image = create_test_image<double>(16, 16);
  func  = irtkInterpolateImageFunction::New(Interpolation_Linear, Extrapolation_Const, image);
  ...
  // Check instantiated image function
  ASSERT_STREQUAL(func->NameOfClass(), "irtkGenericLinearInterpolateImageFunction2D", "Type of interpolator");
  ASSERT_STREQUAL(func->Extrapolator()->NameOfClass(), "irtkGenericConstExtrapolateImageFunction", "Type of extrapolator");
  ...
  // Check instantiated image function
  ASSERT_STREQUAL(func->NameOfClass(), "irtkGenericLinearInterpolateImageFunction3D", "Type of interpolator");
  ASSERT_STREQUAL(func->Extrapolator()->NameOfClass(), "irtkGenericConstExtrapolateImageFunction", "Type of extrapolator");
...
int test_Interpolation_Linear_Extrapolation_NN()
{
  ...
  // 2D
  image = create_test_image<double>(16, 16);
  func  = irtkInterpolateImageFunction::New(Interpolation_Linear, Extrapolation_NN, image);
  ...
  // Check instantiated image function
  ASSERT_STREQUAL(func->NameOfClass(), "irtkGenericLinearInterpolateImageFunction2D", "Type of interpolator");
  ASSERT_STREQUAL(func->Extrapolator()->NameOfClass(), "irtkGenericNearestNeighborExtrapolateImageFunction", "Type of extrapolator");
...
// ---------------------------------------------------------------------------
int irtkInterpolateExtrapolateImageFunctionTest(int, char *[])
{
  int retval = 0;
