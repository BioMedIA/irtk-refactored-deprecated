...
/**
 * Linear interpolation of generic 2D image
 */

template <class TImage>
class irtkGenericLinearInterpolateImageFunction2D
: public irtkGenericLinearInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericLinearInterpolateImageFunction2D);
  irtkGenericInterpolatorTypes(irtkGenericLinearInterpolateImageFunction);

public:

  /// Default constructor
  irtkGenericLinearInterpolateImageFunction2D();
...
/**
 * Linear interpolation of any 2D image
 */

class irtkLinearInterpolateImageFunction2D
: public irtkGenericLinearInterpolateImageFunction2D<irtkBaseImage>
{
  irtkObjectMacro(irtkLinearInterpolateImageFunction2D);
