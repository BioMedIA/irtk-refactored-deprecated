...
#ifndef _IRTKCSPLINEINTERPOLATEIMAGEFUNCTION3D_H
#define _IRTKCSPLINEINTERPOLATEIMAGEFUNCTION3D_H

#include <irtkCSplineInterpolateImageFunction.h>


/**
 * Cubic spline interpolation of generic 3D image
 */

template <class TImage>
class irtkGenericCSplineInterpolateImageFunction3D
: public irtkGenericCSplineInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericCSplineInterpolateImageFunction3D);
...
/**
 * Cubic spline interpolation of any 3D image
 */

class irtkCSplineInterpolateImageFunction3D
: public irtkGenericCSplineInterpolateImageFunction3D<irtkBaseImage>
{
  irtkObjectMacro(irtkCSplineInterpolateImageFunction3D);

public:

  /// Constructor
  irtkCSplineInterpolateImageFunction3D() {}
