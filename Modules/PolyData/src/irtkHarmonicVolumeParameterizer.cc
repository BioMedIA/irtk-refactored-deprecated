...
// -----------------------------------------------------------------------------
irtkHarmonicVolumeParameterizer::irtkHarmonicVolumeParameterizer()
{
}

// -----------------------------------------------------------------------------
irtkHarmonicVolumeParameterizer
::irtkHarmonicVolumeParameterizer(const irtkHarmonicVolumeParameterizer &other)
:
...
// -----------------------------------------------------------------------------
irtkHarmonicVolumeParameterizer &irtkHarmonicVolumeParameterizer
::operator =(const irtkHarmonicVolumeParameterizer &other)
{
...
// -----------------------------------------------------------------------------
irtkMatrix3x3 irtkHarmonicVolumeParameterizer
                       ...
                       const double v2[3], const double v3[3], double volume) const
{
  ...
  return irtkMatrix3x3(c, .0, .0,  .0, c, .0,  .0, .0, c);
}
