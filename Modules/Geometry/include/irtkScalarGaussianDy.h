...
/**
 * First derivative w.r.t y of (multi-dimensional) Gaussian function
 */

class irtkScalarGaussianDy : public irtkScalarGaussian
{
  irtkObjectMacro(irtkScalarGaussianDy);
...
public:
  ...
  irtkScalarGaussianDy(double);

  /// Construct Gaussian with isotropic sigma and specific center
  irtkScalarGaussianDy(double, double, double, double = .0, double = .0);

  /// Construct 3D Gaussian with anisotropic sigma and specific center
  irtkScalarGaussianDy(double, double, double,
                       double, double, double);

  /// Construct 4D Gaussian with anisotropic sigma and specific center
  irtkScalarGaussianDy(double, double, double, double,
                       double, double, double, double);

  /// Destructor
  ~irtkScalarGaussianDy();

  /// Evaluate derivative of 1D Gaussian function w.r.t y
  double Evaluate(double);

  /// Evaluate derivative of 2D Gaussian function w.r.t y
  double Evaluate(double, double);

  /// Evaluate derivative of 3D Gaussian function w.r.t y
  double Evaluate(double, double, double);

  /// Evaluate derivative of 4D Gaussian function w.r.t y
