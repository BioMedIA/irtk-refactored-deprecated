...
class irtkGenericBSplineInterpolateImageFunction
...
public:
  ...
  /// Degree of B-spline
  irtkPublicAttributeMacro(int, SplineDegree);
  ...
  irtkComponentMacro(CoefficientExtrapolator, InfiniteCoefficient);
...
public:
  ...
  /// Constructor
  irtkGenericBSplineInterpolateImageFunction(int = 3);

  /// Destructor
  virtual ~irtkGenericBSplineInterpolateImageFunction();
...
class irtkBSplineInterpolateImageFunction
: public irtkGenericBSplineInterpolateImageFunction<irtkBaseImage>
{
  irtkObjectMacro(irtkBSplineInterpolateImageFunction);

public:

  /// Constructor
  irtkBSplineInterpolateImageFunction(int degree = 3)
  :
    irtkGenericBSplineInterpolateImageFunction<irtkBaseImage>(degree)
  {}
