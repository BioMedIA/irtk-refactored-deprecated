...
#ifndef _IRTKSINCINTERPOLATEIMAGEFUNCTION3D_H
#define _IRTKSINCINTERPOLATEIMAGEFUNCTION3D_H
...
class irtkGenericSincInterpolateImageFunction3D
: public irtkGenericSincInterpolateImageFunction<TImage>
{
  irtkObjectMacro(irtkGenericSincInterpolateImageFunction3D);
  irtkGenericInterpolatorTypes(irtkGenericSincInterpolateImageFunction);

public:

  /// Default constructor
  irtkGenericSincInterpolateImageFunction3D();
...
class irtkSincInterpolateImageFunction3D
: public irtkGenericSincInterpolateImageFunction3D<irtkBaseImage>
{
  irtkObjectMacro(irtkSincInterpolateImageFunction3D);

public:

  /// Constructor
  irtkSincInterpolateImageFunction3D() {}
