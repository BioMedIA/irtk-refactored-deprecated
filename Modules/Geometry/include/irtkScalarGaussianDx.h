...
/**
 * First derivative w.r.t x of (multi-dimensional) Gaussian function
 */

class irtkScalarGaussianDx : public irtkScalarGaussian
{
  irtkObjectMacro(irtkScalarGaussianDx);
...
public:
  ...
  irtkScalarGaussianDx(double);

  /// Construct Gaussian with isotropic sigma and specific center
  irtkScalarGaussianDx(double, double, double, double = .0, double = .0);

  /// Construct 3D Gaussian with anisotropic sigma and specific center
  irtkScalarGaussianDx(double, double, double,
                       double, double, double);

  /// Construct 4D Gaussian with anisotropic sigma and specific center
  irtkScalarGaussianDx(double, double, double, double,
                       double, double, double, double);

  /// Destructor
  ~irtkScalarGaussianDx();

  /// Evaluate derivative of 1D Gaussian function w.r.t x
  double Evaluate(double);

  /// Evaluate derivative of 2D Gaussian function w.r.t x
  double Evaluate(double, double);

  /// Evaluate derivative of 3D Gaussian function w.r.t x
  double Evaluate(double, double, double);

  /// Evaluate derivative of 4D Gaussian function w.r.t x
