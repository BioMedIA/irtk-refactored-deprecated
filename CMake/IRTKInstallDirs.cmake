...
foreach(dir BINDIR
  ...
  set(IRTK_INSTALL_FULL_${dir} "${CMAKE_INSTALL_FULL_${dir}}")
endforeach()

set(IRTK_INSTALL_CMAKEDIR "${IRTK_INSTALL_LIBDIR}/cmake/IRTK" CACHE PATH "")
set(IRTK_INSTALL_FULL_CMAKEDIR "${IRTK_INSTALL_FULL_LIBDIR}/cmake/IRTK")

set(IRTK_INSTALL_EXAMPLEDIR "${IRTK_INSTALL_DOCDIR}/examples" CACHE PATH "")
set(IRTK_INSTALL_FULL_EXAMPLEDIR "${IRTK_INSTALL_FULL_DOCDIR}/examples")
